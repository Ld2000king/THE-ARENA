...
const STAGES = [
    ...
    /* ---- שלבים 51–150: הזירה עוברת "מסע שני" ושלישי — אותם אלופים
       שכבר פגשתם חוזרים חזקים משמעותית (חיים, לא כוח חפיסה, כי כוח
       החפיסה כבר בתקרה). ראו scripts/gen-stages.js למחולל. ---- */

    { n: 51, name: 'שוליית הזירה', title: 'השב לזירה', img: 'art/swamp-crawler.jpg', el: 'green', hp: 114,
      taunt: 'חשבתם שניצחתם אותי? זה היה רק החימום.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 52, name: 'לוחש הביצות', title: 'הניצול', img: 'art/poison-spore.jpg', el: 'green', hp: 118,
      taunt: 'בפעם שעברה חסכתי בכוח. הפעם לא.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 53, name: 'אמן הסופה', title: 'הגרסה המחוזקת', img: 'art/thunder-orb.jpg', el: 'gold', hp: 120,
      taunt: 'הזירה מזינה אותי מחדש בכל פעם שאני נופל.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 54, name: 'נזירת הקרח', title: 'צלקת הזירה', img: 'art/ice-dragoness.jpg', el: 'blue', hp: 124,
      taunt: 'למדתי כל מה שעשית לי. עכשיו התור שלי.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 55, name: 'צייד החולות', title: 'האפר שקם לתחייה', img: 'art/sand-shark.jpg', el: 'gold', hp: 126,
      taunt: 'אתם עדיין אותו דבר. אני כבר לא.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 56, name: 'לוחש הצללים', title: 'הזעם שגדל', img: 'art/shadow-orb.jpg', el: 'purple', hp: 130,
      taunt: 'כל הפסד שלי כאן היה רק אימון.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 57, name: 'מפקד הברזל', title: 'הניצחון שלא נשכח', img: 'art/iron-vanguard.jpg', el: 'orange', hp: 134,
      taunt: 'הפעם לא תצאו מזה בקלות.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 58, name: 'רוזן הדם', title: 'נוקם השבר', img: 'art/blood-knight.jpg', el: 'red', hp: 136,
      taunt: 'תשאלו את מי שכבר ניסה לעצור אותי.',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 59, name: 'מכשף התהום', title: 'הצל ששרד', img: 'art/abyss-mage.jpg', el: 'purple', hp: 140,
      taunt: 'הכוח שלי גדל בכל פעם שאני שב לכאן.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 60, name: 'עריץ הזירה', title: 'המהדורה הקטלנית', img: 'art/dark-fist.jpg', el: 'red', hp: 144,
      taunt: 'לא באתי להפסיד שוב.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 61, name: 'שומרת הקרח', title: 'עוצמה שלא נבדקה', img: 'art/ice-golem.jpg', el: 'blue', hp: 146,
      taunt: 'הפעם הראשונה הייתה טעות שלי. השנייה תהיה שלכם.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 62, name: 'ארכן הפלדה', title: 'האש שלא כבתה', img: 'art/steel-spider.jpg', el: 'blue', hp: 150,
      taunt: 'אני זוכר כל מכה שספגתי. עכשיו אחזיר את כולן.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 63, name: 'רוזן הליל', title: 'משועבד לזירה', img: 'art/night-vampire.jpg', el: 'purple', hp: 154,
      taunt: 'הזירה הזאת שינתה אותי. לרעתכם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 64, name: 'שר הערפל', title: 'המחיר שהוכפל', img: 'art/mist-phantom.jpg', el: 'blue', hp: 158,
      taunt: 'עברתי דרך האש כדי לחזור לכאן.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 65, name: 'אלופת התכלת', title: 'צליין הנקמה', img: 'art/azure-guardian.jpg', el: 'blue', hp: 162,
      taunt: 'לא תזהו אותי הפעם.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 66, name: 'אשף הארגמן', title: 'הכוח שלא נשבר', img: 'art/crimson-warlock.jpg', el: 'pink', hp: 166,
      taunt: 'מי שנפל פעם — קם חזק יותר.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 67, name: 'גור הלהבות', title: 'הענק ששב', img: 'art/lava-cub.jpg', el: 'red', hp: 170,
      taunt: 'הפסד אחד לא מגדיר לוחם. תשעה עשויים.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 68, name: 'מלך העצמות', title: 'אלוף שלא נשכח', img: 'art/lich-king.jpg', el: 'purple', hp: 174,
      taunt: 'הגעתי רחוק מדי כדי לעצור עכשיו.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 69, name: 'דרקון הלבה', title: 'המסע השני', img: 'art/lava-dragon.jpg', el: 'red', hp: 180,
      taunt: 'תכינו את עצמכם. אני כבר לא הצל שהייתי.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 70, name: 'אגרוף האופל', title: 'עדיין כאן', img: 'art/shadow-imp.jpg', el: 'purple', hp: 184,
      taunt: 'כל שלב שעברתם — עוד לוחם שהתחזק.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 71, name: 'שומרת היער', title: 'השב לזירה', img: 'art/ranger-guard.jpg', el: 'green', hp: 188,
      taunt: 'חזרתי. וזה יעלה לכם ביוקר.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 72, name: 'רץ הנצח', title: 'הניצול', img: 'art/chrono-racer.jpg', el: 'red', hp: 192,
      taunt: 'הזמן ביני לביניכם עבד לטובתי.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 73, name: 'אלוף הצללים', title: 'הגרסה המחוזקת', img: 'art/dark-fist.jpg', el: 'purple', hp: 198,
      taunt: 'לא נותר בי דבר מהלוחם שהכרתם.',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 74, name: 'זקיף הברקים', title: 'צלקת הזירה', img: 'art/storm-sentinel.jpg', el: 'orange', hp: 202,
      taunt: 'הפעם הזאת תיגמר אחרת.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 75, name: 'מלך הגחלים', title: 'האפר שקם לתחייה', img: 'art/lava-dragon.jpg', el: 'red', hp: 208,
      taunt: 'אני לא כאן כדי לזכור. אני כאן כדי לנצח.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 76, name: 'חצית הזינוק', title: 'הזעם שגדל', img: 'art/ranger-strike.jpg', el: 'green', hp: 212,
      taunt: 'ספרו את הצלקות. הן שלכם, לא שלי.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 77, name: 'הליבה המכנית', title: 'הניצחון שלא נשכח', img: 'art/machine-guardian.jpg', el: 'blue', hp: 218,
      taunt: 'עוד סיבוב. עוד הזדמנות לכם לטעות.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 78, name: 'אציל הליל', title: 'נוקם השבר', img: 'art/night-vampire.jpg', el: 'purple', hp: 224,
      taunt: 'מי ששרד את הזירה — לא חוזר אותו הדבר.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 79, name: 'נזיר הברק', title: 'הצל ששרד', img: 'art/blue-fist-monk.jpg', el: 'blue', hp: 230,
      taunt: 'תראו מה נשאר כשמפסידים מספיק פעמים ולא שוברים.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 80, name: 'שר הקבר', title: 'המהדורה הקטלנית', img: 'art/lich-king.jpg', el: 'purple', hp: 234,
      taunt: 'זו לא נקמה. זו רק תוצאה טבעית.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 81, name: 'כוהן הארגמן', title: 'עוצמה שלא נבדקה', img: 'art/crimson-warlock.jpg', el: 'pink', hp: 240,
      taunt: 'הכוח האמיתי שלי עוד לא ראיתם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 82, name: 'טיטאן הקרב', title: 'האש שלא כבתה', img: 'art/titan-prime.jpg', el: 'red', hp: 246,
      taunt: 'אתם עדיין חושבים שזה אותו קרב?',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 83, name: 'מצביא הברזל', title: 'משועבד לזירה', img: 'art/iron-vanguard.jpg', el: 'orange', hp: 252,
      taunt: 'כל דור בזירה חזק מקודמו. גם אני.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 84, name: 'אוריון', title: 'המחיר שהוכפל', img: 'art/orion.jpg', el: 'blue', hp: 260,
      taunt: 'לא אתן לכם עוד סיכוי שני.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 85, name: 'ארכנית הפלדה', title: 'צליין הנקמה', img: 'art/steel-spider.jpg', el: 'blue', hp: 266,
      taunt: 'הגעתי לשיא שלי. אתם עדיין בדרך לשלכם.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 86, name: 'פוסע החשיכה', title: 'הכוח שלא נשבר', img: 'art/night-warden.jpg', el: 'blue', hp: 272,
      taunt: 'הזירה לא שוכחת אף לוחם. גם לא אני.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 87, name: 'רוח האובך', title: 'הענק ששב', img: 'art/mist-phantom.jpg', el: 'blue', hp: 280,
      taunt: 'תתכוננו. הצורה הזאת אתם עוד לא פגשתם.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 88, name: 'משמידת הוורד', title: 'אלוף שלא נשכח', img: 'art/rose-destroyer.jpg', el: 'pink', hp: 286,
      taunt: 'אני התהום שממנה עליתם. עכשיו תרדו אליי.',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 89, name: 'ארכי-מכשף התהום', title: 'המסע השני', img: 'art/abyss-mage.jpg', el: 'purple', hp: 294,
      taunt: 'כל שיא שקבעתם — אני עומד לשבור.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 90, name: 'נוסה', title: 'עדיין כאן', img: 'art/nossa.jpg', el: 'gold', hp: 300,
      taunt: 'זה הסוף שלכם, לא ההתחלה שלי.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 91, name: 'מלך הסאיאן', title: 'השב לזירה', img: 'art/saiyan-king.jpg', el: 'blue', hp: 308,
      taunt: 'חשבתם שניצחתם אותי? זה היה רק החימום.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 92, name: 'רוכל הגניבות', title: 'הניצול', img: 'art/shadow-imp.jpg', el: 'purple', hp: 316,
      taunt: 'בפעם שעברה חסכתי בכוח. הפעם לא.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 93, name: 'עריץ החלל', title: 'הגרסה המחוזקת', img: 'art/void-tyrant.jpg', el: 'purple', hp: 324,
      taunt: 'הזירה מזינה אותי מחדש בכל פעם שאני נופל.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 94, name: 'ליבת הרעם', title: 'צלקת הזירה', img: 'art/thunder-orb.jpg', el: 'gold', hp: 332,
      taunt: 'למדתי כל מה שעשית לי. עכשיו התור שלי.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 95, name: 'מונרך השמש', title: 'האפר שקם לתחייה', img: 'art/sun-monarch.jpg', el: 'gold', hp: 340,
      taunt: 'אתם עדיין אותו דבר. אני כבר לא.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 96, name: 'פטרון התכלת', title: 'הזעם שגדל', img: 'art/azure-guardian.jpg', el: 'blue', hp: 348,
      taunt: 'כל הפסד שלי כאן היה רק אימון.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 97, name: 'קולוסוס הקרח', title: 'הניצחון שלא נשכח', img: 'art/ice-golem.jpg', el: 'blue', hp: 358,
      taunt: 'הפעם לא תצאו מזה בקלות.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 98, name: 'אדון הדם', title: 'נוקם השבר', img: 'art/blood-knight.jpg', el: 'red', hp: 366,
      taunt: 'תשאלו את מי שכבר ניסה לעצור אותי.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 99, name: 'אביר הגלקסיה', title: 'הצל ששרד', img: 'art/galaxy-knight.jpg', el: 'gold', hp: 376,
      taunt: 'הכוח שלי גדל בכל פעם שאני שב לכאן.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 100, name: 'נסיך התהום', title: 'המהדורה הקטלנית', img: 'art/abyss-prince.jpg', el: 'purple', hp: 384,
      taunt: 'לא באתי להפסיד שוב.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 101, name: 'שוליית הזירה', title: 'הצורה האמיתית', img: 'art/swamp-crawler.jpg', el: 'green', hp: 394,
      taunt: 'הגעתי רחוק מדי כדי לעצור עכשיו.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 102, name: 'לוחש הביצות', title: 'האגדה הקדומה', img: 'art/poison-spore.jpg', el: 'green', hp: 404,
      taunt: 'תכינו את עצמכם. אני כבר לא הצל שהייתי.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 103, name: 'אמן הסופה', title: 'השיא האחרון', img: 'art/thunder-orb.jpg', el: 'gold', hp: 414,
      taunt: 'כל שלב שעברתם — עוד לוחם שהתחזק.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 104, name: 'נזירת הקרח', title: 'הגרסה הבלתי אפשרית', img: 'art/ice-dragoness.jpg', el: 'blue', hp: 424,
      taunt: 'חזרתי. וזה יעלה לכם ביוקר.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 105, name: 'צייד החולות', title: 'מלך שלא נופל', img: 'art/sand-shark.jpg', el: 'gold', hp: 436,
      taunt: 'הזמן ביני לביניכם עבד לטובתי.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 106, name: 'לוחש הצללים', title: 'אימת הזירה', img: 'art/shadow-orb.jpg', el: 'purple', hp: 446,
      taunt: 'לא נותר בי דבר מהלוחם שהכרתם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 107, name: 'מפקד הברזל', title: 'המהות המוחלטת', img: 'art/iron-vanguard.jpg', el: 'orange', hp: 458,
      taunt: 'הפעם הזאת תיגמר אחרת.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 108, name: 'רוזן הדם', title: 'עוצמת האינסוף', img: 'art/blood-knight.jpg', el: 'red', hp: 470,
      taunt: 'אני לא כאן כדי לזכור. אני כאן כדי לנצח.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 109, name: 'מכשף התהום', title: 'הדרגה העליונה', img: 'art/abyss-mage.jpg', el: 'purple', hp: 480,
      taunt: 'ספרו את הצלקות. הן שלכם, לא שלי.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 110, name: 'עריץ הזירה', title: 'אימה חיה', img: 'art/dark-fist.jpg', el: 'red', hp: 492,
      taunt: 'עוד סיבוב. עוד הזדמנות לכם לטעות.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 111, name: 'שומרת הקרח', title: 'הכוח שלא נבדק', img: 'art/ice-golem.jpg', el: 'blue', hp: 506,
      taunt: 'מי ששרד את הזירה — לא חוזר אותו הדבר.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 112, name: 'ארכן הפלדה', title: 'צל שאין לו קץ', img: 'art/steel-spider.jpg', el: 'blue', hp: 518,
      taunt: 'תראו מה נשאר כשמפסידים מספיק פעמים ולא שוברים.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 113, name: 'רוזן הליל', title: 'אלוהי הזירה הקטן', img: 'art/night-vampire.jpg', el: 'purple', hp: 530,
      taunt: 'זו לא נקמה. זו רק תוצאה טבעית.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 114, name: 'שר הערפל', title: 'השבר הבלתי אפשרי', img: 'art/mist-phantom.jpg', el: 'blue', hp: 544,
      taunt: 'הכוח האמיתי שלי עוד לא ראיתם.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 115, name: 'אלופת התכלת', title: 'האש שאין לה סוף', img: 'art/azure-guardian.jpg', el: 'blue', hp: 558,
      taunt: 'אתם עדיין חושבים שזה אותו קרב?',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 116, name: 'אשף הארגמן', title: 'המלכוד המושלם', img: 'art/crimson-warlock.jpg', el: 'pink', hp: 572,
      taunt: 'כל דור בזירה חזק מקודמו. גם אני.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 117, name: 'גור הלהבות', title: 'הענק שאין לעצור', img: 'art/lava-cub.jpg', el: 'red', hp: 586,
      taunt: 'לא אתן לכם עוד סיכוי שני.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 118, name: 'מלך העצמות', title: 'המוות המושהה', img: 'art/lich-king.jpg', el: 'purple', hp: 600,
      taunt: 'הגעתי לשיא שלי. אתם עדיין בדרך לשלכם.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 119, name: 'דרקון הלבה', title: 'הגורל האחרון', img: 'art/lava-dragon.jpg', el: 'red', hp: 616,
      taunt: 'הזירה לא שוכחת אף לוחם. גם לא אני.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 120, name: 'אגרוף האופל', title: 'שיא הזירה', img: 'art/shadow-imp.jpg', el: 'purple', hp: 630,
      taunt: 'תתכוננו. הצורה הזאת אתם עוד לא פגשתם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 121, name: 'שומרת היער', title: 'הצורה האמיתית', img: 'art/ranger-guard.jpg', el: 'green', hp: 646,
      taunt: 'אני התהום שממנה עליתם. עכשיו תרדו אליי.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 122, name: 'רץ הנצח', title: 'האגדה הקדומה', img: 'art/chrono-racer.jpg', el: 'red', hp: 662,
      taunt: 'כל שיא שקבעתם — אני עומד לשבור.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 123, name: 'אלוף הצללים', title: 'השיא האחרון', img: 'art/dark-fist.jpg', el: 'purple', hp: 680,
      taunt: 'זה הסוף שלכם, לא ההתחלה שלי.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 124, name: 'זקיף הברקים', title: 'הגרסה הבלתי אפשרית', img: 'art/storm-sentinel.jpg', el: 'orange', hp: 696,
      taunt: 'חשבתם שניצחתם אותי? זה היה רק החימום.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 125, name: 'מלך הגחלים', title: 'מלך שלא נופל', img: 'art/lava-dragon.jpg', el: 'red', hp: 714,
      taunt: 'בפעם שעברה חסכתי בכוח. הפעם לא.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 126, name: 'חצית הזינוק', title: 'אימת הזירה', img: 'art/ranger-strike.jpg', el: 'green', hp: 732,
      taunt: 'הזירה מזינה אותי מחדש בכל פעם שאני נופל.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 127, name: 'הליבה המכנית', title: 'המהות המוחלטת', img: 'art/machine-guardian.jpg', el: 'blue', hp: 750,
      taunt: 'למדתי כל מה שעשית לי. עכשיו התור שלי.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 128, name: 'אציל הליל', title: 'עוצמת האינסוף', img: 'art/night-vampire.jpg', el: 'purple', hp: 768,
      taunt: 'אתם עדיין אותו דבר. אני כבר לא.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 129, name: 'נזיר הברק', title: 'הדרגה העליונה', img: 'art/blue-fist-monk.jpg', el: 'blue', hp: 788,
      taunt: 'כל הפסד שלי כאן היה רק אימון.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 130, name: 'שר הקבר', title: 'אימה חיה', img: 'art/lich-king.jpg', el: 'purple', hp: 808,
      taunt: 'הפעם לא תצאו מזה בקלות.',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 131, name: 'כוהן הארגמן', title: 'הכוח שלא נבדק', img: 'art/crimson-warlock.jpg', el: 'pink', hp: 828,
      taunt: 'תשאלו את מי שכבר ניסה לעצור אותי.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 132, name: 'טיטאן הקרב', title: 'צל שאין לו קץ', img: 'art/titan-prime.jpg', el: 'red', hp: 848,
      taunt: 'הכוח שלי גדל בכל פעם שאני שב לכאן.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 133, name: 'מצביא הברזל', title: 'אלוהי הזירה הקטן', img: 'art/iron-vanguard.jpg', el: 'orange', hp: 870,
      taunt: 'לא באתי להפסיד שוב.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 134, name: 'אוריון', title: 'השבר הבלתי אפשרי', img: 'art/orion.jpg', el: 'blue', hp: 892,
      taunt: 'הפעם הראשונה הייתה טעות שלי. השנייה תהיה שלכם.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 135, name: 'ארכנית הפלדה', title: 'האש שאין לה סוף', img: 'art/steel-spider.jpg', el: 'blue', hp: 914,
      taunt: 'אני זוכר כל מכה שספגתי. עכשיו אחזיר את כולן.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } },

    { n: 136, name: 'פוסע החשיכה', title: 'המלכוד המושלם', img: 'art/night-warden.jpg', el: 'blue', hp: 936,
      taunt: 'הזירה הזאת שינתה אותי. לרעתכם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:2, 32:3, 33:3 } },

    { n: 137, name: 'רוח האובך', title: 'הענק שאין לעצור', img: 'art/mist-phantom.jpg', el: 'blue', hp: 960,
      taunt: 'עברתי דרך האש כדי לחזור לכאן.',
      deck: { 26:3, 27:3, 28:3, 32:3, 33:3, 36:3, 37:2 } },

    { n: 138, name: 'משמידת הוורד', title: 'המוות המושהה', img: 'art/rose-destroyer.jpg', el: 'pink', hp: 984,
      taunt: 'לא תזהו אותי הפעם.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 139, name: 'ארכי-מכשף התהום', title: 'הגורל האחרון', img: 'art/abyss-mage.jpg', el: 'purple', hp: 1008,
      taunt: 'מי שנפל פעם — קם חזק יותר.',
      deck: { 22:3, 23:3, 24:3, 25:3, 26:3, 27:3, 28:2 } },

    { n: 140, name: 'נוסה', title: 'שיא הזירה', img: 'art/nossa.jpg', el: 'gold', hp: 1034,
      taunt: 'הפסד אחד לא מגדיר לוחם. תשעה עשויים.',
      deck: { 21:3, 26:3, 27:3, 28:3, 29:3, 30:3, 31:2 } },

    { n: 141, name: 'מלך הסאיאן', title: 'הצורה האמיתית', img: 'art/saiyan-king.jpg', el: 'blue', hp: 1060,
      taunt: 'הגעתי רחוק מדי כדי לעצור עכשיו.',
      deck: { 1:3, 2:3, 3:2, 30:3, 31:3, 34:3, 35:3 } },

    { n: 142, name: 'רוכל הגניבות', title: 'האגדה הקדומה', img: 'art/shadow-imp.jpg', el: 'purple', hp: 1086,
      taunt: 'תכינו את עצמכם. אני כבר לא הצל שהייתי.',
      deck: { 1:3, 2:3, 3:3, 4:3, 5:3, 6:2, 22:3 } },

    { n: 143, name: 'עריץ החלל', title: 'השיא האחרון', img: 'art/void-tyrant.jpg', el: 'purple', hp: 1114,
      taunt: 'כל שלב שעברתם — עוד לוחם שהתחזק.',
      deck: { 5:3, 6:3, 7:3, 8:3, 9:3, 10:3, 11:2 } },

    { n: 144, name: 'ליבת הרעם', title: 'הגרסה הבלתי אפשרית', img: 'art/thunder-orb.jpg', el: 'gold', hp: 1140,
      taunt: 'חזרתי. וזה יעלה לכם ביוקר.',
      deck: { 3:3, 9:3, 10:3, 11:3, 21:3, 22:3, 23:2 } },

    { n: 145, name: 'מונרך השמש', title: 'מלך שלא נופל', img: 'art/sun-monarch.jpg', el: 'gold', hp: 1170,
      taunt: 'הזמן ביני לביניכם עבד לטובתי.',
      deck: { 7:3, 22:3, 23:3, 24:3, 25:3, 26:3, 27:2 } },

    { n: 146, name: 'פטרון התכלת', title: 'אימת הזירה', img: 'art/azure-guardian.jpg', el: 'blue', hp: 1198,
      taunt: 'לא נותר בי דבר מהלוחם שהכרתם.',
      deck: { 9:3, 10:3, 11:3, 21:3, 22:3, 23:2, 24:3 } },

    { n: 147, name: 'קולוסוס הקרח', title: 'המהות המוחלטת', img: 'art/ice-golem.jpg', el: 'blue', hp: 1228,
      taunt: 'הפעם הזאת תיגמר אחרת.',
      deck: { 21:3, 22:3, 23:2, 36:3, 37:3, 38:3, 39:3 } },

    { n: 148, name: 'אדון הדם', title: 'עוצמת האינסוף', img: 'art/blood-knight.jpg', el: 'red', hp: 1260,
      taunt: 'אני לא כאן כדי לזכור. אני כאן כדי לנצח.',
      deck: { 1:2, 34:3, 35:3, 36:3, 37:3, 38:3, 39:3 } },

    { n: 149, name: 'אביר הגלקסיה', title: 'הדרגה העליונה', img: 'art/galaxy-knight.jpg', el: 'gold', hp: 1290,
      taunt: 'ספרו את הצלקות. הן שלכם, לא שלי.',
      deck: { 1:3, 2:3, 7:3, 22:3, 23:3, 24:3, 25:2 } },

    { n: 150, name: 'נסיך התהום', title: 'אימה חיה', img: 'art/abyss-prince.jpg', el: 'purple', hp: 1588,
      taunt: 'עוד סיבוב. עוד הזדמנות לכם לטעות.',
      deck: { 21:3, 22:3, 23:3, 24:3, 25:3, 32:3, 33:2 } }
];
