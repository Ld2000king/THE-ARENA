...
function starterOwned() {
    // מספיק קלפים לבנות חפיסה של 20, עם עודף שמאפשר לשחק בהרכב
    return { 20:3, 19:3, 18:3, 17:3, 16:3, 15:3, 14:3, 13:3, 12:2 };
}

/* החפיסה הפותחת בנויה מהקלפים הטובים שכבר בבעלות (20 קלפים, כוח 85),
   מול שלב 1 שעומד על 70 — פתיחה נוחה ולא הטלת מטבע */
function starterDeck() {
    return { 12:2, 13:3, 14:3, 15:3, 16:3, 17:3, 18:3 };
}
